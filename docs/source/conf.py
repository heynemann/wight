# -*- coding: utf-8 -*-
#
# wight documentation build configuration file, created by
...
latex_documents = [
    (
        'index', 'wight.tex', u'wight Documentation',
...
man_pages = [
    ('index', 'wight', u'wight Documentation',
